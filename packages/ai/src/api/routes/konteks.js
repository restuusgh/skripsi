  ...
  router.get("/konteks", async (req, res) => {
    try {
      ...
      const produkId = Number(req.query.produkId);
      ...
      return res.json({
        ...
        message: adaData ? null : "Belum ada data stok untuk produk ini.",
        ...
        tanggalStok: stokRow?.tanggalUpdate?.toISOString() ?? null,
      });
    } catch (error) {
      console.error(error);
